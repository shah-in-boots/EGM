...
write_wfdb_native_cpp <- function(data_path, header_path, signal_matrix_sexp, channel_names, file_names, storage_format, adc_gain, adc_baseline, adc_units, adc_resolution, adc_zero, initial_value, checksum, blocksize, frequency, samples, record_name, start_time, info_strings) {
  invisible(.Call(`_EGM_write_wfdb_native_cpp`, data_path, header_path, signal_matrix_sexp, channel_names, file_names, storage_format, adc_gain, adc_baseline, adc_units, adc_resolution, adc_zero, initial_value, checksum, blocksize, frequency, samples, record_name, start_time, info_strings))
}
